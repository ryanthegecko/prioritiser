            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li>
                            <a class="nav-link" href="/goals">Your Goals</a>
                        </li>

                        <li>
                            <a class="nav-link add-new-goal" href="#" data-toggle="modal" data-target="#new-goal-modal">Add a new goal</a>
                        </li>
                    </ul>
            ...
            <div class="modal-content">
                <form method="POST" action="/goal">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Add new goal</h2>
